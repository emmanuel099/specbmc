/*
 * Copyright 2017-2020 Authors of Falcon Binary Analysis Framework.
 * Copyright 2020 Emmanuel Pescosta.
 *
 ...
 * the License.
 *
 * Copied and adapted from Falcon (https://github.com/falconre/falcon)
 */
